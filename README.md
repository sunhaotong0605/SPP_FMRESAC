...
### Data Description
The proposed method requires data in [FASTA](https://www.ncbi.nlm.nih.gov/genbank/fastaformat/) format as input. All data are collected and downloaded from the National Center for Biotechnology Information (NCBI). In addition, we also provide data downloads from [Zenodo](https://zenodo.org/records/17067025).
